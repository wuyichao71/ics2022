...
void isa_difftest_attach() {
  ...
  /* bool success; */
  word_t inst;
  word_t csr_code[3] = {MCAUSE, MSTATUS, MTVEC};//, MSTATUS, MEPC, MCAUSE};
  /* printf("here\n"); */
  for (int i = 0; i < ARRLEN(csr_code); i++)
  {
    /* ref_r = cpu; */
    ref_r.pc = RESET_VECTOR + CONFIG_MBASE;
    printf("here\n");
    ...
    printf("0x%08x\n", inst);
    ref_difftest_memcpy(RESET_VECTOR + CONFIG_MBASE, &inst, 4, DIFFTEST_TO_REF);
